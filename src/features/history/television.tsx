  ...
  return (
    <>
      <Table
        headers={headers}
        columns={columns}
        data={[...MOCK_TELEVISION, ...MOCK_TELEVISION, ...MOCK_TELEVISION]}
        currentPage={1}
      />
    </>
  );
